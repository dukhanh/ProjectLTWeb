				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="login.jsp">Đăng Nhập</a></li>
						</ul>
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="register.html">Tạo tài khoản</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
							<p style="margin-left: 23px;">Vui lòng nhập email hoặc số điện thoại để lấy lại mật khẩu</p>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="Nhập Email hoặc số điện thoại" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập Email hoặc số điện thoại'">
							</div>
							<!-- <div class="col-md-12 form-group">
