                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown active">
                                ...
                                <ul class="dropdown-menu">
									<li class="nav-item active"><a class="nav-link" href="categoryAll.jsp">Danh mục cửa hàng</a></li>
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="CategoryAdidas.jsp">Nike</a></li>
                                    <li class="nav-item"><a class="nav-link" href="categoryNike.jsp">Adidas</a></li>
                                </ul>
                            </li>
				...
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						<li class="main-nav-list active"><a href="categoryNam.jsp"><span
							class="lnr lnr-arrow-right active"></span>Nam<span class="number"></span></a>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/OIP (14).jfif" style="height: 280px; width: 263px;" alt="">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/OIP13.jfif" alt="" style="height: 280px;width: 263px;">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nu.jfif">
								<div class="product-details">
									<h6>dành cho nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/shoes-9.png" alt="">
								<div class="product-details">
									<h6>dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nu1.jfif" alt="">
								<div class="product-details">
									<h6>dành cho nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nu2.jfif" alt="">
								<div class="product-details">
									<h6>dành cho nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/shoes-8.png" alt="">
								<div class="product-details">
									<h6>dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nu3.jfif" alt="">
								<div class="product-details">
									<h6>dành cho nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
