                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="category.html">Nam</a></li>
                                    <li class="nav-item"><a class="nav-link" href="category.html">Nữ</a></li>
                                    <li class="nav-item"><a class="nav-link" href="category.html">Trẻ em</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item "><a class="nav-link" href="myAccount.jsp">Chào Duy</a></li>
                        </ul>
        ...
        <div class="search_input" id="search_input_box">
            <div class="container">
                <form class="d-flex justify-content-between">
                    <input type="text" class="form-control" id="search_input" placeholder="Bạn đang tìm gì?">
    ...
    <section class="tracking_box_area section_gap">
        <div class="container">
            <div class="tracking_box_inner">
                <!-- <p>Để theo dõi đơn hàng vui lòng nhập mã đơn hàng của bạn vào ô bên dưới và nhấn nút "Theo dõi".</p> -->
                <h3 style="margin-bottom: 30px;">Thông tin tài khoản</h3>
                <form class="row tracking_form" action="#" method="post" novalidate="novalidate">
                    <!-- <p>Họ tên</p> -->
                    <div style="margin-bottom: 0px; padding-bottom: 0px;" class="col-md-12 form-group">
                    ...
                    <div class="col-md-12 form-group">
                        <input type="text" class="form-control" id="order" name="order" onfocus="this.placeholder = ''" onblur="this.placeholder = ''">
                    </div>
                    ...
                    <div class="col-md-12 form-group">
                        <input type="email" class="form-control" id="email" name="email" onfocus="this.placeholder = ''" onblur="this.placeholder = ''">
                    </div>
