                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item active"><a class="nav-link" href="categoryNike.jsp">Nike</a></li>
                                </ul>
                            </li>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="categoryNike.jsp">Nike</a>
					</nav>
				</div>
			</div>
		</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikeem1.jfif" alt="">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam1.jfif" alt="">
								<div class="product-details">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam2.jfif" alt="">
								<div class="product-details">
									<h6>Nam</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenu1.jfif" alt="">
								<div class="product-details">
									<h6>Nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikeem2.jfif" alt="" style="height: 280px; width: 263px;">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam3.jfif" alt="">
								<div class="product-details">
									<h6>Dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenu2.jfif">
								<div class="product-details">
									<h6>dành cho nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenu3.jfif" alt="">
								<div class="product-details">
									<h6>Nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikeem3.jfif" alt="">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam4.jfif" alt="">
								<div class="product-details">
									<h6>Nam</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikeem4.jfif" alt="">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenu4.jfif" alt="">
								<div class="product-details">
									<h6>dành cho nữ</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
