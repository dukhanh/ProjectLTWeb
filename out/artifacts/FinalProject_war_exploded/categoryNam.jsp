                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item active"><a class="nav-link" href="categoryNam.jsp">Nam</a></li>
			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						<li class="main-nav-list "><a href="categoryNam.jsp"><span
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam2.jfif">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam1.jfif">
								<div class="product-details">
									<h6>dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam3.jfif">
								<div class="product-details">
									<h6>Nam</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/nike/nikenam4.jfif">
								<div class="product-details">
									<h6>Dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/adidas/adinam3.jfif" alt="">
								<div class="product-details">
									<h6>dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/shoes-6.png" alt="">
								<div class="product-details">
									<h6>Nam</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/shoes-5.png " alt="">
								<div class="product-details">
									<h6>dành cho người chơi thể thao</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
