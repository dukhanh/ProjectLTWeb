                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item active"><a class="nav-link" href="categoryTreem.jsp">Trẻ em</a></li>
                                </ul>
                            </li>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="categoryTreem.jsp">Trẻ Em</a>
					</nav>
				</div>
			</div>
		</div>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/adidas/adiem1.jfif">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/adidas/adiem2.jfif">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/adidas/em2.jfif">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/adidas/adiem3.jfif">
								<div class="product-details">
									<h6>Giày cho béo</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
                                <img class="img-fluid" src="img/adidas/adiem4.jfif">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/OIP (14).jfif" alt="">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/OIP13.jfif" alt="">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="img/adidas/em1.jfif">
								<div class="product-details">
									<h6>Giày cho bé</h6>
									<div class="price">
										<h6>150.00 ₫</h6>
